  ...
  setup() {
    ...
    const cargarProductos = async () => {
      try {
        ...
        loading.value = false
        crearGraficos() // Vuelve a crear los gráficos con los datos actualizados
      }
    }
    ...
    const crearGraficos = () => {
      ...
      ;[barrasHorizontalesChart, barrasVerticalesChart, lineaChart, pieChart].forEach(
        (chartRef) => {
      ...
      barrasHorizontalesChart.value.chartInstance = new Chart(barrasHorizontalesChart.value, {
        type: 'bar',
        data: {
          labels: marcas,
          datasets: [
      ...
      barrasVerticalesChart.value.chartInstance = new Chart(barrasVerticalesChart.value, {
        type: 'bar',
        data: {
      ...
      lineaChart.value.chartInstance = new Chart(lineaChart.value, {
        type: 'line',
        data: {
          labels: meses,
          datasets: [
      ...
      pieChart.value.chartInstance = new Chart(pieChart.value, {
        type: 'doughnut',
        data: {
          labels: marcas,
          datasets: [
    ...
    onMounted(async () => {
      await cargarProductos() // cargarProductos ya llama a crearGraficos en su bloque finally
    })
